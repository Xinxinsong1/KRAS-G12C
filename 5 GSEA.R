...
gseaplot(kk2,geneSetID = "hsa05171")
gseaplot2(kk2, geneSetID = "hsa04010",color = "firebrick",pvalue_table=T)
...
gseaplot2(gsemf, geneSetID="GO:0042605",color = "firebrick",pvalue_table=T)
...
gseaplot2(gsebp, geneSetID="GO:2001020",color = "firebrick",pvalue_table=T)
...
gseaplot2(gsecc, geneSetID="GO:0012507",color = "firebrick",pvalue_table=T)
...
gsemf1 <- setReadable(gsemf, OrgDb = org.Hs.eg.db)
write.csv(summary(gsemf1),"GO MF-GSEA.csv",row.names =FALSE)
gseaplot(gsemf, geneSetID="GO:0016887")
gseaplot2(gsemf, geneSetID="GO:0016887",color = "firebrick",pvalue_table=T)
...
gsecc1 <- setReadable(gsecc, OrgDb = org.Hs.eg.db)
write.csv(summary(gsecc1),"GO CC-GSEA.csv",row.names =FALSE)
gseaplot(gsecc, geneSetID="GO:0016887")
gseaplot2(gsecc, geneSetID="GO:0016887",color = "firebrick",pvalue_table=T)
